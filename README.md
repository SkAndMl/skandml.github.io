...
- Graded students assignments related to Data Science, Machine Learning, Math and Statistics

**Machine Learning Intern @ FeyNN Labs (_December 2021 - March 2022_)**
- Conducted data collection, processing, and analysis for a customer segmentation project for a real estate company
- Worked on the application of machine learning for optimizing food chain of local restaurants 

## Projects
### Poetika
[Website](https://poetika.streamlit.app/)
